 ...
 */
fun myProfile() {
    var namaDepan = "Annisa"
    var namaBelakang = "Rahmawati"
    val umur = 21
    val statustrue = "Singel"
    val statusfalse = "Tidak"
    println(namaDepan + " Laila " + namaBelakang)
    println(umur)
 ...
 */
fun myGroup(): String {
    val groupMembers = listOf("Ila", "Aulia", "Delima", "Dian", "Kanro")
